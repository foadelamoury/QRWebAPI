    ...
    <div class="container">
        ...
        <div class="share-section">
            ...
            <div class="share-buttons">
                ...
                <button onclick="shareImage()" class="share-btn instagram" title="Share">
    ...
    <script>
        ...
        async function shareImage() {
            ...
            try {
                ...
                await copyImageAndShare(imageUrl);
                ...
                if (error.name !== 'AbortError') {
                    ...
                    try {
                        ...
                        showToast('Please download the image and share manually');
                    }
                }
            }
        }

        async function copyImageAndShare(imageUrl) {
            try {
                // Fetch the image
                const response = await fetch(imageUrl);
                if (!response.ok) throw new Error('Failed to fetch image');
                ...
                if (navigator.clipboard && navigator.clipboard.write) {
                    ...
                    showToast('Please download the image to share');
                }
            } catch (error) {
